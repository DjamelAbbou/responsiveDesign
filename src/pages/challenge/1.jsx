export default function Index() {
  return (
    <>
      <div className="mx-auto mb-5 w-fit text-2xl font-bold">
        This is the first challenge and here are the instructions:
      </div>
      <div className="mx-auto mb-10 w-fit bg-red-500 text-center text-xl font-medium text-white">
        1) Limit the total width of the .intro-conent to about half of it's
        parent
        <br />
      ...
      <div class="mx-auto mt-10 w-[50%] bg-green-900 p-8 text-white">
        <div class="">
          <h1>Lorem ipsum dolor sit.</h1>
          <p>
            Lorem ipsum dolor sit, amet consectetur adipisicing elit. Quod unde
